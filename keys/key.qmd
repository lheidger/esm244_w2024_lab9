...
seeds_df <- read_tsv(here::here('data/seeds_dataset.txt'), #read_tsv reads text files
                     col_names = FALSE,
                     na = '-999') %>%
  setNames(var_names) %>%
...
seeds_hc_complete <- hclust(seeds_dist, method = "complete") #changing methods really changes dendrograms
